...
# species arose), which was then soon followed by at least one mutation in one of the duplicates. Specifically, this script narrows down to
# within a region of A. suecica, At-Chr.3, approx. 3,300,000-3,400,000 bps in, where a series of single duplications of genes has occurred.
...
def dup_read_check(sue_dup_pileup):
	...
	sue_pileup = Pileup.Parse(sue_filename,True,["AtChr1","AtChr2","AtChr3:1-23049423","AtChr4","AtChr5"])
	#sue_pileup = Pileup.Parse(sue_filename,True,"AtChr3:1-23049423")
	non_dup_avg = sue_pileup.Coverage()
	rand = 1000
	dup_avg, rand_overlap = sue_pileup.Coverage("AtChr3:3300000-3400000", rand)
...
dup_genes = GFF.Parse_Genes("../thalyrata.gff","AtChr3:3300000-3400000")

sue_filename = "Data/SueAll/Sue-OurRESCAN/libsSue/ThalyrataAlignment/cleaned-RESCANlibsSue_sxn_pileup_simplified.txt"
sue_dup_pileup = Pileup.Parse(sue_filename,True,"AtChr3:3300000-3400000")
...
sue_sun_filename = "Output/IsSUN_AtChr3.txt" # Debugging file
sue_notsun_filename = "Output/NotSUN_AtChr3.txt" # Debugging file
...
outfilename = "Output/Sue_SUN_Genes_(Within_At-Chr3).txt"
